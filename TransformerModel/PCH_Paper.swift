...
class PCH_Paper: PCH_Insulation {
    ...
    init(type:PaperType, thickness:Double, width:Double, length:Double)
    {
        ...
        super.init(name: "Kraft paper", density: 1000.0, cost: PCH_Costs.sharedInstance.CostForKey(PCH_Costs.CostKey.Paper), material: Insulation.Paper, shrinkageFactor:0.85, εRel: 1.0)
    }
}
